...

{
	...
	void (__cdecl *bufferSwitch) (long doubleBufferIndex, ASIOBool directProcess);
	...
	void (__cdecl *sampleRateDidChange) (ASIOSampleRate sRate);
	...
	long (__cdecl *asioMessage) (long selector, long value, void* message, double* opt);
	...
	ASIOTime* (__cdecl *bufferSwitchTimeInfo) (ASIOTime* params, long doubleBufferIndex, ASIOBool directProcess);
...
ASIOError __cdecl ASIOInit(ASIODriverInfo *info);
...
ASIOError __cdecl ASIOExit(void);
...
ASIOError __cdecl ASIOGetBufferSize(long *minSize, long *maxSize, long *preferredSize, long *granularity);
...
ASIOError __cdecl ASIOCreateBuffers(ASIOBufferInfo *bufferInfos, long numChannels,
...
ASIOError __cdecl ASIODisposeBuffers(void);
...
ASIOError __cdecl ASIOControlPanel(void);
