...
#ifndef _KX_Cross_EFFECT_H
#define _KX_Cross_EFFECT_H

#define CROSS_2_PARAMS_COUNT	1	// number of user-visible parameters

// Plugin definition
class iCross_2_Plugin : public iKXPlugin
{
public:
	...
	virtual int get_param_count(void) {return CROSS_2_PARAMS_COUNT;}
	...
	kxparam_t _params[CROSS_2_PARAMS_COUNT]; // place to store parameters inside of plugin
};

// Plugin GUI definition
class iCross_2_PluginDlg : public CKXPluginGUI
{
public:
	iCross_2_Plugin *plugin;

    	// constructor:
	iCross_2_PluginDlg(iCross_2_Plugin *plg, kDialog *parent_, kFile *mf_) : CKXPluginGUI(parent_,mf_) {plugin = plg; };
...
declare_effect_source(Crossover_2);
