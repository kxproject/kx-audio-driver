...
#ifndef _KX_THESMALLDELAY_EFFECT_H
#define _KX_THESMALLDELAY_EFFECT_H

#define THEDELAY_PARAMS_COUNT	1	// number of user-visible parameters

// Plugin definition
class iTheSmallDelayPlugin : public iKXPlugin
{
public:
...
class iTheSmallDelayPluginDlg : public CKXPluginGUI
{
public:
	iTheSmallDelayPlugin *plugin;

    	// constructor:
	iTheSmallDelayPluginDlg(iTheSmallDelayPlugin *plg, kDialog *parent_, kFile *mf_) : CKXPluginGUI(parent_,mf_) {plugin = plg; };
...
declare_effect_source(TheSmallDelay);
