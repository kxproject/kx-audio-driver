...
#undef DXTRACE_ERR
#define DXTRACE_ERR(A,B) 0
#undef DXTRACE_ERR_NOMSGBOX
#define DXTRACE_ERR_NOMSGBOX(A,B) 0
...
//-----------------------------------------------------------------------------
HRESULT CSoundManager::Initialize( LPGUID Guid,
				   HWND  hWnd, 
                                   DWORD dwCoopLevel, 
                                   ...
                                   DWORD dwPrimaryBitRate )
{
    ...
    if( FAILED( hr = DirectSoundCreate8( Guid, &m_pDS, NULL ) ) )
