...
static kxparam_t default_params[TIMBRE_PARAMS_COUNT] = {0, 0};
...
void iTimbrePluginDlg::init()
{
	...
	create_dialog(plugin_name(timbre), 200, 220,-1,KXFX_NO_RESIZE);

	// SHOW_VFADER(Fader, Ctrl_ID, Label, MinVal, MaxVal, Left, Top, Width, Height)
	create_vfader(fdrBass, BASS_ID, " Bass", -120, 120, 5, 12, 50, 170);
	create_vfader(fdrTreble, TREBLE_ID, " Treble", -120, 120, 50, 12, 50, 170);
