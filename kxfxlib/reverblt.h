...
#ifndef _KX_REVERB_LT_H
#define _KX_REVERB_LT_H

// Number of plugin parameters
#define REVERBLT_PARAMS_COUNT	5

// Plugin definition
class iReverbLitePlugin : public iKXPlugin
{
public:
// members of iKXPlugin
	...
	virtual int get_param_count(void) {return REVERBLT_PARAMS_COUNT;}
...
// not members of iKXPlugin
	kxparam_t _params[REVERBLT_PARAMS_COUNT]; // actually just copies of fader positions, in future i guess they always be copyes of UI elements values
};

// Plugin GUI definition
class iReverbLitePluginDlg : public CKXPluginGUI
{
public:
	iReverbLitePlugin *plugin;

    	// constructor:
	iReverbLitePluginDlg(iReverbLitePlugin *plg, kDialog *parent_,kFile *mf_) : CKXPluginGUI(parent_,mf_) {plugin = plg; };
...
declare_effect_source(reverblt);

#endif // _KX_REVERB_LT_H
